...
app.get('/v1/me', async (_request:any, reply:any) => reply.code(501).send({ error:'AUTH_CONTEXT_NOT_MIGRATED' }));
app.patch('/v1/me/profile', async (_request:any, reply:any) => reply.code(501).send({ error:'AUTH_CONTEXT_NOT_MIGRATED' }));
