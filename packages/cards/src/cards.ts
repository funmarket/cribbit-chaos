...
const actionMasters: CardDefinition[] = [
  ...
  { id: "tag", family: "tag", name: "TAG", image: "cards/tag/tag_01.jpg", description: "Choose another player to tag along: when you perform the relevant real draw, they draw exactly 1 extra real card; no extra action is granted.", copies: 3, lifecycle: "exhausted_after_resolution" },
  ...
  { id: "reverse_confession", family: "reverse_confession", name: "REVERSE CONFESSION", image: "cards/reverse_confession/fIYGR_01.jpg", description: "Choose another player; the selected target gives one confession about themselves without revealing whether it is real or fabricated.", copies: 3, lifecycle: "exhausted_after_resolution" },
