...
const actionMasters: CardDefinition[] = [
  ...
  { id: "reverse", family: "reverse", name: "REVERSE", image: "cards/reverse/reverse_01.jpg", description: "Change turn direction.", copies: 6, lifecycle: "reusable" },
  { id: "draw", family: "draw", name: "DRAW", image: "cards/draw/draw_01.jpg", description: "Apply the canonical Draw-card effect.", copies: 6, lifecycle: "reusable" },
  ...
  { id: "truth", family: "truth", name: "TRUTH", image: "cards/truth/truth_01.jpg", description: "Trigger Roulette for an eligible Truth prompt.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "dare", family: "dare", name: "DARE", image: "cards/dare/dare_01.jpg", description: "Trigger Roulette for an eligible Dare prompt.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "paranoia", family: "paranoia", name: "PARANOIA", image: "cards/paranoia/paranoia_01.jpg", description: "Paranoia social card; final mission is defined by the Game Bible.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "chaos", family: "chaos", name: "CHAOS", image: "cards/chaos/chaos_01.jpg", description: "CHAOS card; exact effect catalogue is defined by the Game Bible.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "duel", family: "duel", name: "DUEL", image: "cards/duel/duel_01.jpg", description: "Challenge another player; loser draws 1 after Duel resolution.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "nope", family: "nope", name: "NOPE", image: "cards/nope/nope_01.jpg", description: "Personal defense against eligible targeted card effects.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "tag", family: "tag", name: "TAG", image: "cards/tag/tag_01.jpg", description: "Attack + relocate rotation.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "truth_or_chaos", family: "truth_or_chaos", name: "TRUTH OR CHAOS", image: "cards/truth_or_chaos/truth_or_chaos_01.jpg", description: "Target chooses Truth or Dare; Roulette serves the selected type.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "hijack", family: "hijack", name: "HIJACK", image: "cards/hijack/hijack_01.jpg", description: "Sacrifice your current turn and relocate rotation.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "taboo", family: "taboo", name: "TABOO", image: "cards/taboo/taboo_01.jpg", description: "Ask one chosen player a question: YES or draw 1.", copies: 3, lifecycle: "exhausted_after_resolution" },

  { id: "machiavelli", family: "machiavelli", name: "MACHIAVELLI", image: "cards/machiavelli/machiavelli_01.jpg", description: "Add, change, or remove an eligible active rule.", copies: 1, lifecycle: "exhausted_after_resolution" },
  { id: "ghost", family: "ghost", name: "GHOST", image: "cards/ghost/ghost_01.jpg", description: "Face-down delayed threat / timed interruption.", copies: 1, lifecycle: "persistent_until_resolution" },
  { id: "reverse_confession", family: "reverse_confession", name: "REVERSE CONFESSION", image: "cards/reverse_confession/fIYGR_01.jpg", description: "Confess something about yourself. It can be real or made up — do not say which one it is.", copies: 3, lifecycle: "exhausted_after_resolution" },
  { id: "dig_me", family: "dig_me", name: "DIG ME", image: "cards/Dig_Me/digme.jpg", description: "Choose a player. They must answer a question about you.", copies: 1, lifecycle: "exhausted_after_resolution" },
];
