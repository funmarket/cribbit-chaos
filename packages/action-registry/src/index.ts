...
export const CONTROL_ASSIGNMENTS: readonly ControlAssignment[] = [
  ...
  { selector:'[data-source]:not([data-action])', backendClass:'client-only', target:'room setup draft', notes:'Drafted locally until host applies room config; gameplay data-action controls must bypass this selector.' },
